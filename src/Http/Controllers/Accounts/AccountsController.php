...
namespace NextDeveloper\Affiliate\Http\Controllers\Accounts;

use Illuminate\Http\Request;
use NextDeveloper\Affiliate\Http\Controllers\AbstractController;
use NextDeveloper\Commons\Http\Response\ResponsableFactory;
use NextDeveloper\Affiliate\Http\Requests\Accounts\AccountsUpdateRequest;
use NextDeveloper\Affiliate\Database\Filters\AccountsQueryFilter;
use NextDeveloper\Affiliate\Database\Models\Accounts;
use NextDeveloper\Affiliate\Services\AccountsService;
use NextDeveloper\Affiliate\Http\Requests\Accounts\AccountsCreateRequest;
