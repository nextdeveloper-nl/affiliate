...
namespace NextDeveloper\Affiliate;
 ...
 */
class AffiliateServiceProvider extends AbstractServiceProvider {
    /**
     * @var bool
     */
    ...
    public function boot() {
        ...
        $this->loadViewsFrom($this->dir.'/../resources/views', 'Affiliate');
...
//    }
    ...
    protected function registerRoutes() {
        if ( ! $this->app->routesAreCached()) {
            $this->app['router']
                ->namespace('NextDeveloper\Affiliate\Http\Controllers')
